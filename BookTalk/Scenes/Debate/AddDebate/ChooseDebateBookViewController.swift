//
//  ChooseDebateBookViewController.swift
//  BookTalk
//
...
class ChooseDebateBookViewController: UIViewController {
    ...
    private lazy var nextButton: SquareButton = {
        ...
        button.addTarget(self, action: #selector(goToMakeSubject), for: .touchUpInside)
        return button
    }()
    
    @objc func goToMakeSubject() {
...
extension ChooseDebateBookViewController {
...
extension ChooseDebateBookViewController: UITableViewDelegate {
...
extension ChooseDebateBookViewController: UITableViewDataSource {
    //section 당 row 수
